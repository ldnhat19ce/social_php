	 ...
	 <!-- PROFILE-IMAGE -->
		...
		<div class="profile-name-wrap">
			<div class="profile-name">
				<a href="<?php echo BASE_URL.'profile/'.$guestUser->getUsername(); ?>"><?php echo $guestUser->getScreenName(); ?></a>
			</div>
	...
	<!-- in left end-->
		...
		<div class="wrapper-following">
			<div class="wrap-follow-inner">
				<?php 
					if(!empty($followDAO->findByUserReceive($guestUser->getId()))):
						$listFollowing = $followDAO->findByUserReceive($guestUser->getId());
						foreach($listFollowing as $list):
							$user = $userDAO->findById($list->getUserSender());
				?>
